    ...
    <section id="contact" className="section bg-white relative">
      <div className="container relative z-10">
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">
          ...
          {/* Info Side */}
          <div className="bg-brand-navy text-white p-8 md:p-12 lg:w-2/5 flex flex-col justify-between relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-heading font-black mb-4">{t('contact.title')}</h3>
          ...
          {/* Form Side */}
          <div className="p-8 md:p-12 lg:w-3/5 bg-[#F5F5F5] flex flex-col justify-center">
            <h3 className="text-2xl md:text-3xl font-heading font-black text-brand-navy mb-8">{t('contact.formTitle')}</h3>
