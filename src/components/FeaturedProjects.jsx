    ...
    <section id="projects" className="section bg-white">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 mt-4">Showcasing our commitment to quality and large-scale industrial excellence.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute -inset-full bg-gradient-to-r from-transparent via-brand-gold/10 to-transparent skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
