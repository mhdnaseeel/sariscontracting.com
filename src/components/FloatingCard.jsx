...
const FloatingCard = () => {
  return (
    ...
    >
      ...
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-brand-gold/20 blur-3xl rounded-full -mr-16 -mt-16" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
          <div>
            ...
            <h4 className="text-2xl font-heading font-black text-white mb-2 leading-tight">PREMIUM INDUSTRIAL SERVICES</h4>
            <p className="text-gray-400 text-sm">Certified standards for global excellence in Saudi Arabia's infrastructure.</p>
          </div>
          
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-1 bg-brand-gold rounded-full" />
              <span className="text-xs font-bold uppercase tracking-widest text-brand-gold">Est. 2014</span>
            </div>
            <div className="bg-white/5 p-4 rounded-2xl border border-white/10 group-hover:border-brand-gold/50 transition-colors">
              <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1 font-bold">Current Status</p>
              <p className="text-white font-bold">Project Excellence Verified</p>
            </div>
          </div>
        </div>
      </motion.div>
